      ...
      <div className="dlg howto-dlg">
        ...
        <div className="howto-body">
          ...
          <div className="howto-section">
            ...
            <p>Your songbook is your personal library. Add songs from the Public Songbook or import from a spreadsheet.</p>
          </div>
          ...
          {isMobile ? (
            <>
              <div className="howto-section">
                ...
                <p>Tap a song to select it — a panel slides up with options. Tap <strong>Play Now</strong> to play it. Songs you play are tracked automatically.</p>
              </div>

              <div className="howto-section">
                <div className="howto-sec-title">Filtering</div>
                <p>Select a song, then tap the filter chips (KEY, BPM, ERA…) that appear in the sort bar to highlight compatible songs in your library.</p>
              </div>

              <div className="howto-section">
                <div className="howto-sec-title">Queue</div>
                <p>Tap <strong>+ Queue</strong> in the song panel to add to your queue. Tap the <strong>↑</strong> button on the Now Playing bar to view and manage the queue.</p>
              </div>

              <div className="howto-section">
                <div className="howto-sec-title">Now Playing</div>
                <p>The bar at the bottom shows your current song. Tap it to open the queue. Tap <strong>chords</strong> to open the chord chart. Tap <strong>✕</strong> to clear.</p>
              </div>

              <div className="howto-section">
                <div className="howto-sec-title">Saving Sets</div>
                <p>Your played songs are tracked per session. Use the right panel on desktop to save your setlist as a playlist.</p>
              </div>
            </>
          ) : (
            <>
    ...
    <>
      <nav className="nav">
        ...
        <div className="nav-center">
          <div className="nav-tabs-row">
            <NavLink to="/dashboard" end className={({ isActive }) => `nav-tab-link${isActive ? ' active' : ''}`}>
              <span className="nav-tab-desktop">my songbook</span>
              <span className="nav-tab-mobile">mine</span>
            </NavLink>
            <NavLink to="/marketplace" className={({ isActive }) => `nav-tab-link${isActive ? ' active' : ''}`}>
              <span className="nav-tab-desktop">public songbook</span>
              <span className="nav-tab-mobile">public</span>
            </NavLink>
          </div>
        </div>
        ...
        <div className="nav-right">
          {user && <span className="nav-notif-wrap"><NotificationDropdown /></span>}
          <button
